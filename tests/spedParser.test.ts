...
describe('SpedParser - casos de borda', () => {
  ...
  it('reporta progresso ao processar arquivo grande', () => {
    // 1 header + 600 linhas (deve acionar múltiplos callbacks, STEP=200)
    const linhas = ['|0000|0|0|01012025|31012025|...|'];
    for (let i = 0; i < 300; i++) {
      linhas.push('|C100|1|0|00|0|00|55|'+(1000+i)+'|CHAVE|01012025|01012025|1,00|...|...|...|1,00|');
