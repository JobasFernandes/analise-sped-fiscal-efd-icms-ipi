...
import { filtrarDadosProcessadosPorPeriodo, formatarMoeda, prepararDadosVendasPorDia } from '../src/utils/dataProcessor';
...
describe('dataProcessor - filtros e totais', () => {
  it('recalcula totais ao filtrar por período', () => {
    ...
    const filtrado = filtrarDadosProcessadosPorPeriodo(dados, '2025-01-01', '2025-01-02');
    expect(filtrado.totalEntradas).toBe(30); // 10 + 20
    expect(filtrado.totalSaidas).toBe(100); // apenas 2025-01-01
